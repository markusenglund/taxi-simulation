...
public class PassengerSurplusGraph : MonoBehaviour
{
  ...
  (float[] quartiledUtilitySurplusPerCapita, int[] quartiledPopulation) CalculateQuartiledUtilitySurplusPerCapita()
  {
    ...
    {
      float utilitySurplus = passenger.person.trip != null ? passenger.person.trip.droppedOffPassengerData.utilitySurplus : 0;
      float hourlyIncome = passenger.person.economicParameters.hourlyIncome;
