...
public class DriverProfitGraph : MonoBehaviour
{
    ...
    public static DriverProfitGraph Create(Transform prefab, Vector3 screenPos, SimulationSettings simSettings, DriverPool driverPool)
    {
        ...
        DriverProfitGraph graph = graphTransform.GetComponent<DriverProfitGraph>();
        graph.maxX = simSettings.simulationLengthHours;
        graph.driverPool = driverPool;
        return graph;
    }
