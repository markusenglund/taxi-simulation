...
class NetValueCalculation(Scene):
    def construct(self):
        equationStart = MathTex(r"netValueUber", r"=", r"tripValue", r"- fare", r"- (timeCost \cdot timeToArrival)", font_size=DEFAULT_FONT_SIZE)
...
class NetValueCalculationBus(Scene):
   def construct(self):
      equationStart = MathTex(r"netValueBus", r"=", r"tripValue", r"- fare", r"- (timeCost \cdot timeToArrival)", font_size=DEFAULT_FONT_SIZE)
      equationStart[0].set_color(YELLOW)
